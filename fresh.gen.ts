...
import * as $12 from "./routes/dashboard/api/solicitude.ts";
import * as $13 from "./routes/dashboard/api/todo.ts";
import * as $14 from "./routes/dashboard/api/vaccine.ts";
import * as $15 from "./routes/dashboard/index.tsx";
import * as $16 from "./routes/dashboard/patients.tsx";
import * as $17 from "./routes/dashboard/solicitudes.tsx";
...
const manifest = {
  routes: {
    ...
    "./routes/dashboard/api/solicitude.ts": $12,
    "./routes/dashboard/api/todo.ts": $13,
    "./routes/dashboard/api/vaccine.ts": $14,
    "./routes/dashboard/index.tsx": $15,
    "./routes/dashboard/patients.tsx": $16,
    "./routes/dashboard/solicitudes.tsx": $17,
